            ...
            <div className="max-w-480 mx-auto px-3">
                ...
                <div className="flex flex-col lg:flex-row justify-between gap-16 lg:gap-24 mb-24">
                    ...
                    <div className="w-full lg:max-w-xl flex flex-col">
                        <h2 className="text-white text-2xl font-medium tracking-tight mb-4">
                            nobadfonts.in
                        </h2>
                        ...
                        <form className="relative flex items-center w-full" onSubmit={(e) => e.preventDefault()}>
                            <input
                                ...
                                className="w-full bg-transparent border-b border-zinc-800 py-2 pr-8 text-sm text-white placeholder-zinc-600 focus:outline-none focus:border-white transition-colors rounded-none"
                                required
                            />
                            <button
                                type="submit"
                                className="absolute right-0 text-zinc-500 hover:text-white transition-colors"
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-x-8 gap-y-12 w-full">
                        ...
                        <div className="flex flex-col space-y-4">
                            <h3 className="text-white text-xs font-semibold tracking-wider uppercase mb-2">The Archive</h3>
                            <a href="/fonts/sans-serif" className="text-sm hover:text-white transition-colors">Sans-Serif</a>
                            <a href="/fonts/serif" className="text-sm hover:text-white transition-colors">Serif</a>
                            <a href="/fonts/display" className="text-sm hover:text-white transition-colors">Display</a>
                            <a href="/fonts/monospace" className="text-sm hover:text-white transition-colors">Monospace</a>
                            <a href="/fonts/variable" className="text-sm hover:text-white transition-colors">Variable</a>
                        </div>

                        {/* Column 2: Platform & Tools */}
                        <div className="flex flex-col space-y-4">
                            <h3 className="text-white text-xs font-semibold tracking-wider uppercase mb-2">Platform</h3>
                        ...
                        <div className="flex flex-col space-y-4">
                            <h3 className="text-white text-xs font-semibold tracking-wider uppercase mb-2">Font Licenses</h3>
                        ...
                        <div className="flex flex-col space-y-4">
                            <h3 className="text-white text-xs font-semibold tracking-wider uppercase mb-2">Site Policies</h3>
                ...
                <div className="flex flex-col md:flex-row justify-between items-center gap-6 pt-8 border-t border-zinc-900">
                    ...
                    <div className="flex items-center gap-6 text-sm">
                        ...
                        <a href="https://github.com" target="_blank" rel="noreferrer" className="hover:text-white transition-colors flex items-center gap-1 group">
                            GitHub
                            <svg className="w-3 h-3 opacity-0 -translate-x-1 group-hover:opacity-100 group-hover:translate-x-0 transition-all" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><line x1="7" y1="17" x2="17" y2="7"></line><polyline points="7 7 17 7 17 17"></polyline></svg>
                        </a>
                        <a href="https://instagram.com" target="_blank" rel="noreferrer" className="hover:text-white transition-colors flex items-center gap-1 group">
                            Instagram
                            <svg className="w-3 h-3 opacity-0 -translate-x-1 group-hover:opacity-100 group-hover:translate-x-0 transition-all" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><line x1="7" y1="17" x2="17" y2="7"></line><polyline points="7 7 17 7 17 17"></polyline></svg>
                        </a>
                    </div>
