        ...
        <>
            <motion.nav
                ...
                className={cn(
                    ...
                    isScrolled
                        ? "top-0 max-w-full md:rounded-none bg-[rgb(var(--color-background)/0.5)] border-b backdrop-blur-3xl pt-[env(safe-area-inset-top)] md:pt-0 py-2 md:py-4 px-6 md:px-10"
